...
//        }
    ...
    public static final long MAX_SELECT_DURATION = Long.MAX_VALUE;
    ...
    private class Track {
        ...
        private final AnimatedFloat selectedT = new AnimatedFloat(TimelineView2.this, 360, CubicBezierInterpolator.EASE_OUT_QUINT);
    ...
    public TimelineView2(Context context, ViewGroup container, View previewContainer, Theme.ResourcesProvider resourcesProvider, BlurringShader.BlurManager blurManager) {
        super(context);
...
//            }
    ...
    protected void dispatchDraw(Canvas canvas) {
        final Paint blurPaint = null;
        try {
            backgroundBlur.getPaint(1f);
        }catch (Throwable t) {
            FileLog.e(t);
        }
...
//                        }
    ...
    private class VideoThumbsLoader {
        ...
        public class BitmapFrame {
            ...
            private final AnimatedFloat alpha = new AnimatedFloat(0, TimelineView2.this, 0, 240, CubicBezierInterpolator.EASE_OUT_QUINT);
    ...
    private class AudioWaveformLoader {
        private final AnimatedFloat animatedLoaded = new AnimatedFloat(TimelineView2.this, 0, 600, CubicBezierInterpolator.EASE_OUT_QUINT);
