...
public class RecordControl2 extends View implements FlashViews.Invertable {
    ...
    private static final long MAX_DURATION = Long.MAX_VALUE;
    ...
    public RecordControl2(Context context) {
        super(context);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float sweepAngle = (duration / (float) (60 * 1000L) * 360)%360;
        ...
        if (showLock) {
            ...
            if (scale > 0) {
                ...
                canvas.rotate(currentAngle, leftCx, cy);
    ...
    public void setAngle(float angle) {
        ...
        rotationAnimator = ValueAnimator.ofFloat(currentAngle, angle);
